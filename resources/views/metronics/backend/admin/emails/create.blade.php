...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            {!! Form::open(['route'=>'backend.email.store', 'enctype' => 'multipart/form-data']) !!}
                ...
                <div class="form-group">
                    ...
                    {!! Form::text('banner_top_url', '', array('class'=>'form-control')) !!}
                    {{$errors->first('banner_top_url')}}
                </div>

                <div class="form-group">
                    {!! Form::label('banner_top_title', 'Banner Top Title') !!}
                    {!! Form::text('banner_top_title', '', array('class'=>'form-control')) !!}
                ...
                <div class="form-group">
                    ...
                    {!! Form::text('banner_bottom_url', '', array('class'=>'form-control')) !!}
                    {{$errors->first('banner_bottom_url')}}
                </div>

                <div class="form-group">
                    {!! Form::label('banner_bottom_title', 'Banner Bottom Title') !!}
                    {!! Form::text('banner_bottom_title', '', array('class'=>'form-control')) !!}
                    {{$errors->first('banner_bottom_title')}}
                </div>

                <div class="form-group">
                    {!! Form::label('recipient', 'Recipient') !!}
                    {!! Form::select('recipient', array("all"=>"All","seller"=>"Seller Only","buyer"=>"Buyer Only"), '1', ['class'=>'form-control']) !!}
