                                                ...
                                                <div class="col-md-8">
                                                        <p class="form-control-static">
                                                            {!! $baseObject->renderAttribute($key, [
                                                                'type' => [
                                                                    App\SuitEvent\Models\Performer::TYPE_INTERNATIONAL => "<span class='label label-blue label-primary'>#type#</span>",
                                                                    App\SuitEvent\Models\Performer::TYPE_NATIONAL => "<span class='label label--lime label-warning'>#type#</span>"
                                                                ]
                                                            ]) !!}
                                                        </p>
                                                </div>
            ...
            <div class="portlet light bordered">
                <div class="portlet-title tabbable-line">
                    ...
                    <ul class="nav nav-tabs">
                        <li class="active">
                            <a href="#portlet_tab1" data-toggle="tab"> Additional Information </span></a></a>
                        </li>
                        <li>
                            <a href="#portlet_tab2" data-toggle="tab"> Reviews (Rate) </span></a></a>
                        </li>
                    </ul>
                </div>
                <div class="portlet-body">
                    <div class="tab-content">
                        <div class="tab-pane active" id="portlet_tab1">
                            ...
                            <div class="text-right">
                                <a class="btn blue" href="{{ route('backend.performerspec.create')."?performer_id=".$baseObject->id }}">
                            ...
                            <br><br>
                            <table id="performerspec" class="table table--zebra"  data-enhance-ajax-table="{{ route('backend.performerspec.index.json') . "?_token=" . csrf_token() . "&performer_id=" . $baseObject->id }}">
                              <thead>
                                  <tr>
                                    <td><b>Type</b></td>
                                    <td><b>Position Order</b></td>
                                    <td><b>Key</b></td>
                                    <td><b>Value</b></td>
                        ...
                        <div class="tab-pane" id="portlet_tab2">
                            <br>
                            <div class="text-right">
                                <a class="btn blue" href="{{ route('backend.performerreview.create')."?performer_id=".$baseObject->id }}">
                                    <span class="fa fa-fw fa-plus"></span>
                                    Add New
                                </a>
                            </div>
                            ...
                            <br><br>
                            <table id="performerreview" class="table table--zebra"  data-enhance-ajax-table="{{ route('backend.performerreview.index.json') . "?_token=" . csrf_token() . "&performer_id=" . $baseObject->id }}">
                              <thead>
                                  <tr>
                                    <td><b>User</b></td>
                                    <td><b>Rate</b></td>
