...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="{{ route('backend.performer-candidate.show', ['id'=>$baseObject->performer_1_id]) }}">{{ ($baseObject->performer1 ? $baseObject->performer1->getFormattedValue() : "Unknown Performer") }}</a>
            <i class="fa fa-circle"></i>
        </li>
        <li>
            <span>Create</span>
