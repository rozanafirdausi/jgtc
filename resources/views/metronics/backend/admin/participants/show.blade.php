            ...
            <div class="portlet light bordered">
                <div class="portlet-title tabbable-line">
                    ...
                    <ul class="nav nav-tabs">
                        <li class="active">
                            <a href="#portlet_tab1" data-toggle="tab"> Participant Answer </a>
                        </li>
                </div>
                <div class="portlet-body">
                    <div class="tab-content">
                        <div class="tab-pane active" id="portlet_tab1">
                            ...
                            <br><br>
                            <table id="productpicture" class="table table--zebra"  data-enhance-ajax-table="{{ route('backend.participantanswer.index.json') . "?_token=" . csrf_token() . "&participant_id=" . $baseObject->id }}">
                              <thead>
                                  <tr>
                                    <td><b>Question</b></td>
                                    <td><b>Free Text Answer (Value)</b></td>
