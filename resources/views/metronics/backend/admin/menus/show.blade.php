                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                        ...
                                                        {!! $baseObject->renderAttribute($key, [
                                                            'condition' => [
                                                                App\SuitEvent\Models\Product::CONDITION_NEW => "<span class='label label--blue label-primary'>#condition#</span>",
                                                                App\SuitEvent\Models\Product::CONDITION_SECOND => "<span class='label label--lime label-success'>#condition#</span>"
                                                            ]
                                                        ]) !!}
                                                        </p>
                                                </div>
