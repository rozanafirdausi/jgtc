...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="{{ route($routeBaseName . '.index') }}">{{ $baseObject->getLabel() }}</a>
            <i class="fa fa-circle"></i>
        </li>
        <li>
            <span>Detail</span>
...
<h3 class="page-title"><span class="font-green sbold uppercase">{{ $baseObject }}</span>
    <small>{{ $baseObject->getLabel() }} Detail</small>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet light">
                        ...
                        <div class="portlet-body">
                            <div class="row form-horizontal form-body">
                                <div class="col-md-12">
                                    ...
                                    @if( !in_array($key, [ 'id', 'content', 'category_id' ] ) )
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                        ...
                                                        {!! $baseObject->renderAttribute($key, [
                                                            'status' => [
                                                                  App\SuitEvent\Models\Content::PUBLISHED_STATUS => "<span class='label label--blue label-primary'>#status#</span>",
                                                                  App\SuitEvent\Models\Content::DRAFT_STATUS => "<span class='label label--lime label-danger'>#status#</span>"
                                                              ]
                                                        ]) !!}
                                                        </p>
                                                </div>
                        ...
                        <div class="portlet-title">
                            <div class="caption font-green-sharp">
                                <i class="fa fa-black-tie font-green-sharp"></i>&nbsp;
                                <span class="caption-subject bold uppercase">{{ $baseObject->attribute_settings['content']['label'] }}</span>
                            </div>
                            <div class="actions">
                            </div>
                        </div>
                        <div class="portlet-body">
                            <div class="row form-horizontal form-body">
                                <div class="col-md-12">
                                    <p>
                                        {!! htmlspecialchars_decode($baseObject->renderAttribute('content')) !!}
                                    </p>
                                </div>
                            </div>
                        </div>
