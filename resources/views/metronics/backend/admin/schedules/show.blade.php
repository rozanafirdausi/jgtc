                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="portlet_tab1">
                            ...
                            <div class="text-right">
                                <a class="btn blue" href="{{ route('backend.performerschedule.create')."?schedule_id=".$baseObject->id }}">
                            ...
                            <br><br>
                            <table id="performerschedule" class="table table--zebra"  data-enhance-ajax-table="{{ route('backend.performerschedule.index.json') . "?_token=" . csrf_token() . "&schedule_id=" . $baseObject->id }}">
                              <thead>
                                  <tr>
                                    <td><b>Performer</b></td>
