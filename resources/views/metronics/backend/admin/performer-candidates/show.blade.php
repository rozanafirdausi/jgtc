            ...
            <div class="portlet light bordered">
                <div class="portlet-title tabbable-line">
                    ...
                    <ul class="nav nav-tabs">
                        @if ($baseObject->type == 'collab' && $baseObject->collab_type == 'main')
                        <li class="active">
                            <a href="#portlet_tab6" data-toggle="tab"> Collaborators </a></a>
                        </li>
                        @endif
                    </ul>
                </div>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="portlet_tab6">
                            ...
                            <div class="text-right">
                                <a class="btn blue" href="{{ route('backend.performer-group.create')."?performer_1_id=".$baseObject->id }}">
                            ...
                            <br><br>
                            <table id="performer-group" class="table table--zebra"  data-enhance-ajax-table="{{ route('backend.performer-group.index.json') . "?_token=" . csrf_token() . "&performer_1_id=" . $baseObject->id }}">
                              <thead>
                                  <tr>
                                    <td><b>#</b></td>
                                    <td><b>Support Collaborator</b></td>
