...
<div class="page-bar">
    <ul class="page-breadcrumb">
        <li>
            <a>Message Management</a>
            <i class="fa fa-circle"></i>
        </li>
        <li>
            <a href="{{ route($routeBaseName . '.index') }}">Discussion</a>
            <i class="fa fa-circle"></i>
        </li>
        <li>
            <span>List</span>
...
<h3 class="page-title">Discussion List
      ...
      <div class="portlet light portlet-fit portlet-datatable bordered">
        <div class="portlet-title">
              <div class="caption">
                  ...
                  <span class="caption-subject font-dark sbold uppercase">Master Diskusi</span>
              </div>
              <div class="actions">
