...
export const slickPrev = '<button type="button" class="slick-prev" type="button"><span class="fas fa-long-arrow-alt-left"></span></button>'
export const slickNext = '<button type="button" class="slick-next" type="button"><span class="fas fa-long-arrow-alt-right"></span></button>'
