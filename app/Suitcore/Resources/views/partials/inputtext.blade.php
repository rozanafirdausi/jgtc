...
<div class='form-row' id='{{ $formSetting['container_id'] }}'>
    <div class='bzg'>
        ...
        <div class='bzg_c' data-col='l8'>
            <input class='form-input' id='{{ $formSetting['id'] }}' type='text' name='{{ $formSetting['name'] }}' value='{{ $formSetting['value'] }}' {{ $formSetting['required'] ? 'required' : '' }} {{ $formSetting['readonly'] ? 'readonly' : '' }}>
