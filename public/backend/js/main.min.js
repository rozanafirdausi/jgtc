    ...
    var Site = {
        ...
        datatableYadcf: function () {
            ...
            $.each($tables, function (index, table) {
                ...
                var containers = yContainer != null ? yContainer.split(',') : null;
                ...
                var yadcfOptions = new Array(containers.length);
                ...
                $('select.yadcf-filter').attr('style', 'width: 80%;');
                $('div.yadcf-filter-wrapper-inner').attr('style', 'width: 80%;');
                $('input.yadcf-filter-range-date').addClass('form-input form-control').attr('style', 'width: 45%;');
